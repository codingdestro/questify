  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-linear-to-br from-indigo-50 via-white to-purple-50">
        ...
        <section className="container mx-auto px-4 py-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2">
              <div className="w-14 h-14 bg-linear-to-br from-indigo-500 to-indigo-600 rounded-lg flex items-center justify-center mb-6">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2">
              <div className="w-14 h-14 bg-linear-to-br from-purple-500 to-purple-600 rounded-lg flex items-center justify-center mb-6">
              ...
              <p className="text-gray-600">
                Access unlimited practice questions tailored to your learning
                pace and style.
              </p>
            </div>

            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2">
              <div className="w-14 h-14 bg-linear-to-br from-pink-500 to-pink-600 rounded-lg flex items-center justify-center mb-6">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2">
              <div className="w-14 h-14 bg-linear-to-br from-indigo-500 to-purple-600 rounded-lg flex items-center justify-center mb-6">
        ...
        {/* Analytics Section */}
        <section className="container mx-auto px-4 py-20">
          <div className="bg-linear-to-r from-indigo-600 to-purple-600 rounded-3xl p-12 md:p-16 text-white">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <TrendingUp className="w-6 h-6 mt-1 shrink-0" />
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <Sparkles className="w-6 h-6 mt-1 shrink-0" />
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <Users className="w-6 h-6 mt-1 shrink-0" />
                    <div>
        ...
        <section className="container mx-auto px-4 py-20">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              <div className="w-16 h-16 bg-linear-to-br from-indigo-600 to-purple-600 text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4">
                1
              </div>
        ...
        <section className="container mx-auto px-4 py-20 text-center">
          ...
          <Link
            href="/signup"
            className="inline-flex items-center gap-2 px-10 py-5 bg-linear-to-r from-indigo-600 to-purple-600 text-white rounded-lg text-xl font-semibold hover:shadow-2xl transform hover:-translate-y-1 transition"
          >
