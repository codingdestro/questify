...
export default function Page() {
  ...
  return (
    <main className="min-h-screen bg-linear-to-br from-sky-50 via-white to-sky-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <h1 className="text-3xl font-bold text-foreground">Your Quizzes</h1>
        ...
        {loading !== "idle" ? (
          <div className="card-mint py-16">
            <Loader state={loading} size="sm" message="Fetching quizzes..." />
          </div>
              ...
              >
                <div className="flex flex-col h-full">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <span
                      className={`text-xs font-semibold px-2.5 py-1 rounded-full shrink-0 ${difficultyColors[sheet.difficulty] ||
          ...
          <div className="card-mint text-center py-16 border ">
            ...
            <p className="text-foreground-muted mb-6  mx-auto">
